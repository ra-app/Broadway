...
build() {
  emcc $c_files -O3 -D_ERROR_PRINT -s TOTAL_MEMORY=209715200 -s ALLOW_MEMORY_GROWTH=0 -s WASM=1 --memory-init-file 1 -s NO_EXIT_RUNTIME=1 -s NO_FILESYSTEM=1 -s INVOKE_RUN=0 -s DOUBLE_MODE=0  -s AGGRESSIVE_VARIABLE_ELIMINATION=1  -s ALIASING_FUNCTION_POINTERS=1 -s DISABLE_EXCEPTION_CATCHING=1  --js-library library.js $EXPORT_FLAGS -Isrc -Iinc --extern-pre-js ../templates/DecoderPre.js --extern-post-js ../templates/DecoderPost.js -o ./js/avc.js
}
